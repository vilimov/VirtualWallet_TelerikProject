    ...
    public class WalletContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var users = new List<User>()
            {
                ...
                new User { Id = 13, Username = "GwynneShotwell", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-1), Password = HashPasswordInternal("123", salt), Email = "GwShotwell@SpaceX.com", PhoneNumber = "1224364852", Photo = "GwynneShotwell.jpg", IsAdmin = false, IsBlocked = false, WalletId = 12},
                new User { Id = 14, Username = "SafraCatz", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-1), Password = HashPasswordInternal("123", salt), Email = "SafraCatz@Oracle.com", PhoneNumber = "1234567890", Photo = "SafraCatz.jpg", IsAdmin = false, IsBlocked = false, WalletId = 12}
            };
