...
namespace Virtual_Wallet.VirtualWallet.Persistence.Data
{
    public class WalletContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new User { Id = 1, Username = "ElonMusk", FirstName = "Elon", LastName = "Musk", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-6), Password = HashPasswordInternal("password123", salt), Email = "elon@musk.com", PhoneNumber = "1234567890", Photo = "images/users/elon_musk.jpg", IsAdmin = true, IsBlocked = false, WalletId = 1},
                new User { Id = 2, Username = "JeffBezos", FirstName = "Jeff", LastName = "Bezos", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-6), Password = HashPasswordInternal("password456", salt), Email = "jeff@amazon.com", PhoneNumber = "9876543210", Photo = "images/users/jeff_bezos.jpg", IsAdmin = false, IsBlocked = false, WalletId = 2},
                new User { Id = 3, Username = "WarrenBuffett", FirstName = "Warren", LastName = "Buffett", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-5), Password = HashPasswordInternal("password789", salt), Email = "warren@berkshire.com", PhoneNumber = "9876543210", Photo = "images/users/warren_buffett.jpg", IsAdmin = false, IsBlocked = false, WalletId = 3},
                new User { Id = 4, Username = "BillGates", FirstName = "Bill", LastName = "Gates", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-5), Password = HashPasswordInternal("password111", salt), Email = "BillGates@gmaill.com", PhoneNumber = "1234567890", Photo = "images/users/bill_gates.jpg", IsAdmin = true, IsBlocked = false, WalletId = 4},
                new User { Id = 5, Username = "LarryEllison", FirstName = "Larry", LastName = "Ellison", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-3), Password = HashPasswordInternal("password222", salt), Email = "larry@oracle.com", PhoneNumber = "9876543210", Photo = "images/users/larry_ellison.jpg", IsAdmin = false, IsBlocked = false, WalletId = 5},
                new User { Id = 6, Username = "MarkZuckerberg", FirstName = "Mark", LastName = "Zuckerberg", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-2), Password = HashPasswordInternal("password333", salt), Email = "mark@facebook.com", PhoneNumber = "1234567890", Photo = "images/users/mark_zuckerberg.jpg", IsAdmin = true, IsBlocked = false, WalletId = 6},
                new User { Id = 7, Username = "LarryPage", FirstName = "Larry", LastName = "Page", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-2), Password = HashPasswordInternal("password444", salt), Email = "larry@google.com", PhoneNumber = "9876543210", Photo = "images/users/larry_page.jpg", IsAdmin = false, IsBlocked = false, WalletId = 7},
                new User { Id = 8, Username = "SergeyBrin", FirstName = "Sergey", LastName = "Brin", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-2), Password = HashPasswordInternal("password555", salt), Email = "sergey@google.com", PhoneNumber = "1234567890", Photo = "images/users/sergey_brin.jpg", IsAdmin = false, IsBlocked = false, WalletId = 8},
                ...
                new User { Id = 11, Username = "Admin", FirstName = "Admin", LastName = "Adminov", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-1), Password = HashPasswordInternal("123", salt), Email = "mkm_vw@abv.bg", PhoneNumber = "1234567890", Photo = "images/users/Admin.jpg", IsAdmin = true, IsBlocked = false, WalletId = 11},
                new User { Id = 12, Username = "User", FirstName = "User", LastName = "Userov", Salt = salt, VerifiedAt = DateTime.Now.AddDays(-1), Password = HashPasswordInternal("123", salt), Email = "User@user.com", PhoneNumber = "1234567890", Photo = "images/users/User.jpg", IsAdmin = false, IsBlocked = false, WalletId = 12},
