...
namespace Virtual_Wallet.VirtualWallet.Persistence.Data
{
    public class WalletContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Transaction { Id = 1, Date = DateTime.Now.AddDays(-10), Amount = 111, SenderId = 1, RecipientId = 10, Description = "Transaction", TransactionType = TransactionType.InternalOutCome,  AmountReceived= (decimal?)101.03, CurrencyExchangeRate=0.9102},
                new Transaction { Id = 2, Date = DateTime.Now.AddDays(-9), Amount = 222, SenderId = 2, RecipientId = 9, Description = "Transfer to my friend Amancio ", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)202.06, CurrencyExchangeRate=0.9102},
                new Transaction { Id = 3, Date = DateTime.Now.AddDays(-8), Amount = 333, SenderId = 3, RecipientId = 8, Description = "buying new car", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)303.10, CurrencyExchangeRate=0.9102},
                new Transaction { Id = 4, Date = DateTime.Now.AddDays(-7), Amount = 444, SenderId = 4, RecipientId = 7, Description = "Payment over invoice 12345678", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)790.59, CurrencyExchangeRate=1.7806},
                new Transaction { Id = 5, Date = DateTime.Now.AddDays(-6), Amount = 555, SenderId = 5, RecipientId = 6, Description = "Invoice 22446688", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)555, CurrencyExchangeRate=0},
                new Transaction { Id = 6, Date = DateTime.Now.AddDays(-5), Amount = 666, SenderId = 1, RecipientId = 11, Description = "Deposit for vacation", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)1185.88, CurrencyExchangeRate=1.7806},
                new Transaction { Id = 7, Date = DateTime.Now.AddDays(-4), Amount = 200, SenderId = 1, RecipientId = 1, Description = "Some cash for my wallet ;)", TransactionType = TransactionType.BankTransfer, CardNumber = "************0752"},
                new Transaction { Id = 8, Date = DateTime.Now.AddDays(-4), Amount = 1024, SenderId = 2, RecipientId = 2, Description = "Transfer from card", TransactionType = TransactionType.BankTransfer, CardNumber = "************3371"},
                new Transaction { Id = 9, Date = DateTime.Now.AddDays(-4), Amount = 50000, SenderId = 6, RecipientId = 6, Description = "Transfer from card", TransactionType = TransactionType.BankTransfer, CardNumber = "************7891"},
                new Transaction { Id = 10, Date = DateTime.Now.AddDays(-4), Amount = 1200, SenderId = 1, RecipientId = 6, Description = "Pay my rent", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)2136.72, CurrencyExchangeRate=1.7806},
                new Transaction { Id = 11, Date = DateTime.Now.AddDays(-4), Amount = (decimal)505.55, SenderId = 5, RecipientId = 3, Description = "Give Warren some coins", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)283.61, CurrencyExchangeRate=0.5616},
                new Transaction { Id = 12, Date = DateTime.Now.AddDays(-3), Amount = (decimal)33.24, SenderId = 6, RecipientId = 1, Description = "payment", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)18.53, CurrencyExchangeRate=0.5616},
                new Transaction { Id = 13, Date = DateTime.Now.AddDays(-3), Amount = 156, SenderId = 4, RecipientId = 4, Description = "why not to cash back some money", TransactionType = TransactionType.Withdrawal, CardNumber="************6716"},
                new Transaction { Id = 14, Date = DateTime.Now.AddDays(-3), Amount = (decimal)22.99, SenderId = 4, RecipientId = 4, Description = "personal stuff", TransactionType = TransactionType.BankTransfer, CardNumber="************3371"},
                new Transaction { Id = 15, Date = DateTime.Now.AddDays(-3), Amount = 50, SenderId = 1, RecipientId = 1, Description = "I am transfering some money back to my card", TransactionType = TransactionType.Withdrawal, CardNumber="************0752"},
                new Transaction { Id = 16, Date = DateTime.Now.AddDays(-2), Amount = (decimal)0.01, SenderId = 1, RecipientId = 2, Description = "donation", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)0.01, CurrencyExchangeRate=0},
                new Transaction { Id = 17, Date = DateTime.Now.AddDays(-2), Amount = (decimal)12225.35, SenderId = 1, RecipientId = 3, Description = "Payment for invoice 223332556", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)12225.35, CurrencyExchangeRate=0},
                new Transaction { Id = 18, Date = DateTime.Now.AddDays(-2), Amount = 336, SenderId = 1, RecipientId = 2, Description = "Invoice 103104105", TransactionType = TransactionType.InternalOutCome, AmountReceived= (decimal?)336, CurrencyExchangeRate=0},
                new Transaction { Id = 19, Date = DateTime.Now.AddDays(-2), Amount = 1024, SenderId = 1, RecipientId = 1, Description = "Transfer from card", TransactionType = TransactionType.BankTransfer, CardNumber="************3371"},
                new Transaction { Id = 20, Date = DateTime.Now.AddDays(-2), Amount = 1566, SenderId = 1, RecipientId = 1, Description = "Transfer from card", TransactionType = TransactionType.BankTransfer, CardNumber="************3371"}
